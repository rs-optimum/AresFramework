...
using AresFramework.Model.Plugins.Entities.Npcs;
using NLog;
...
public class NpcInteractionMap
{
    ...
    /// </summary>
    private readonly Dictionary<string, NpcInteractionsPlugin.HandleInteraction> _mappedInteractions = new();
    ...
    public void AddInteraction(string option, NpcInteractionsPlugin.HandleInteraction interaction, string source = "")
    {
    ...
    /// </summary>
    private static readonly NpcInteractionsPlugin.HandleInteraction DefaultInteraction = (player, npc, option) =>
    {
    ...
    /// <returns></returns>
    public NpcInteractionsPlugin.HandleInteraction GetInteraction(string option)
    {
        _mappedInteractions.TryGetValue(option, out var foundValue);
